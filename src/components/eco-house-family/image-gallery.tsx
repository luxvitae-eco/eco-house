      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight text-foreground">Spaces That Grow With You</h2>
            <p className="mt-4 text-lg text-muted-foreground">
              From sunlit courtyards to adaptable rooms — see how sustainable living fits family life.
            </p>
          </div>
